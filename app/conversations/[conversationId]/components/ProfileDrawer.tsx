...
const ProfileDrawer: React.FC<ProfileDrawerProps> = ({isOpen, onClose, data}) => {
    ...
    const isAcive = members.indexOf(otherUser?.email!) !== -1;
                                            ...
                                            <div className="flex items-start justify-end">
                                                <div className="ml-3 flex items-center">
                                                    <button onClick={onClose}
                                                        type="button" className="rounded-md bg-white text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2">
